...
export function Toolbar({ activeTab, onTabChange, bunkerId, onRefresh, hideBar }: ToolbarProps) {
  ...
  const baseButton = "px-6 py-6 rounded-xl text-sm font-bold transition-all duration-300 border-2 uppercase tracking-wider relative overflow-hidden group";
        ...
        <div className="relative bg-gradient-to-br from-[#2a3447] via-[#1f2937] to-[#1a1f2e] border-[3px] border-[#4deeac] rounded-3xl px-6 py-4 shadow-[0_0_40px_rgba(77,238,172,0.6),0_10px_60px_rgba(0,0,0,0.5)] backdrop-blur-sm">
          ...
          <div className="relative flex items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2.5 pl-4">
              ...
              >
                <span className="relative z-10 flex items-center gap-3 pl-2">
